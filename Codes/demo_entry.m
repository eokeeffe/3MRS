...
figure;
imshow(im1),hold on;
plot(cleanedPoints3(:,1),cleanedPoints3(:,2),'+','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',6);hold on;
title('reference image');
figure;
imshow(im2),hold on;
plot(cleanedPoints4(:,1),cleanedPoints4(:,2),'+','MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',6);hold on;
title('sensed image');
