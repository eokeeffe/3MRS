% In this implementation rotation invariance part and corner point detection are not included.

function [des_m1,des_m2,eo1,eo2,m1] = RIFT_no_rotation_invariance(im1,im2,s,o,patch_size)

% m1 and m2 are the maximum moment maps;
% eo1{s,o} = log-Gabor convolution sequence for scale s and orientation o.
